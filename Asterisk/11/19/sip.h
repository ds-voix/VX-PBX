...
#define DEFAULT_VMEXTEN        "vm" /*!< Default voicemail extension */  /* PnD! */
#define DEFAULT_CALLERID       "Anonymous" /*!< Default caller ID */ /* PnD! */
...
#define DEFAULT_REALM          "vx-pbx" /*!< Realm for HTTP digest authentication */ /* PnD! */
...
#define DEFAULT_USERAGENT  "VX-PBX"  /*!< Default Useragent: header unless re-defined in sip.conf */  /* PnD! */
#define DEFAULT_SDPSESSION "VX-PBX"  /*!< Default SDP session name, (s=) header unless re-defined in sip.conf */  /* PnD! */
#define DEFAULT_SDPOWNER   "root"          /*!< Default SDP username field in (o=) header unless re-defined in sip.conf */
#define DEFAULT_ENGINE     "asterisk"      /*!< Default RTP engine to use for sessions */  /* PnD! */
