...
// PnD!
				teluri_scheme = !strncasecmp(uri, "tel:", 4);
				uri += l;
				break;
			}
		}
...
// <PnD!>
		...
		/* tel: TEL URI INVITE RFC3966 patch */
		if ((c = strstr(uri, ";phone-context="))) {
			...
			*hostport = uri;
			...
			/* Global number without context or domain */
			userinfo = uri;
			*hostport = uri;
		}
// </PnD!>
...
// <PnD!>
	struct testdata td11 = {
		...
		.uri = "tel:098765321;phone-context=+32987654321;param=discard;transport=tcp;param2=residue",
		.user = "098765321",
		.pass = "",
	...
	struct testdata td12 = {
		...
		.uri = "tel:+32987654321;param=discard;transport=tcp;param2=residue",
		.user = "+32987654321",
		.pass = "",
		.hostport = "+32987654321",
		.headers = "",
